...
| Token | Hex | Role |
|-------|-----|------|
| `--bg` | `#FAF7ED` | Cream/Ivory main background |
...
- Asymmetric bento grid compositions
- Ultra-fine kinetic lines (1px strokes)
- One accent (orange) used at most 2x per section
